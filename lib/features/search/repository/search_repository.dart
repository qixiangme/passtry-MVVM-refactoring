...
class SearchRepository {
  ...
  Future<List<PostModel>> searchPosts(String query, {int page = 1, String sort = "latest"}) async { //기본값 최신순순
    try {
      return await searchApi.searchPosts(query, page: page, sort: sort);
    } catch (e) {

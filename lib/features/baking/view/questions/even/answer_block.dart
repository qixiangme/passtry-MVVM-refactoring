...
class AnswerBlock extends ConsumerStatefulWidget {
  final Mission mission;
  final InterviewModel inteview;
  const AnswerBlock({super.key, required this.mission, required this.inteview});

  @override
  ConsumerState<AnswerBlock> createState() => _AnswerBlockState();
}

//로그인 로딩 처리
class _AnswerBlockState extends ConsumerState<AnswerBlock> {

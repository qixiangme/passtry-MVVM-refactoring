...
class _QnaListPageState extends State<QnaListPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(child: QnaListView(qnaItems: qnaList)),
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return QnaCard(question: item.question, answer: item.answer);
      },
    );
  }
}
...
class QnaViewScreen extends StatelessWidget {
  ...
  const QnaViewScreen({Key? key, required this.question, required this.answer})
    : super(key: key);
